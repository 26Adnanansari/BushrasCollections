...
- [ ] **Google Merchant Center:** Setup dynamic product feed for free Google Shopping listings.
- [ ] **Social Retargeting:** Build the admin interface to view basic pixel firing statistics.

## 🌍 Personalization & User Experience
- [ ] **Auto-Language & Currency (Must Do):** Automatically detect user IP country and convert USD/EUR/AED prices.
- [ ] **Location-Specific Content:** Show specific banners/notifications (e.g., "Free Delivery in Karachi" or "Fast Shipping to UK").
- [ ] **Admin UI:** Create a dashboard module so the admin can turn Auto-Currency ON/OFF easily.

## 🔒 Fraud Prevention & Security
- [ ] **VPN/Proxy Detection:** Reject or flag high-risk checkout attempts using VPNs.
